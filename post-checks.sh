...
echo "Found $(ls dataset_in/images/*/*.jpg | wc -l) images."
echo "Found $(ls dataset_in/labels/*/*.txt | wc -l) labels."
echo "Found $(find dataset_in -name '*.txt' -size 0 | wc -l) empty labels."
